...
export default function Welcome() {
    ...
    return (
        <>
            ...
            <div className="flex min-h-screen flex-col sm:px-8 md:px-12 lg:px-20 xl:px-32">
                <div className="flex flex-1 px-4 sm:px-8 md:px-12 lg:px-20 xl:px-32">
                    {/* Left side - Illustration */}
                    <div className="flex flex-1 items-center justify-center p-8">
                        {/* Replace with your JPG image */}
                        <img
                            src="/images/taletunes.png" // IMPORTANT: Ensure this path is correct
                ...
                {/* Footer */}
                <div className="mt-auto pb-8 text-center text-sm text-gray-500 dark:bg-transparent dark:text-white">
